...
class _ReservationPageState extends State<ReservationPage> {
  ...
  Future<bool> _calculateDistance() async {
    try {
      ...
      if (startPlacemark != null && destinationPlacemark != null) {
        ...
        _toDestination = destinationCoordinates;
  ...
  _createReservation(String dirOrigen, String dirDestino, double costo, bool visa, bool mastercard, String fecha, String hora) async {
    ...
    var jsonData;
    var response = await http.post("http://springbootbackendcarsharingapi103-env.eba-2nmwr2r3.us-east-1.elasticbeanstalk.com/api/reservas", headers: {"Content-Type": "application/json" }, body: bodyRequest);
    print(widget.id);
    print(bodyRequest);
              ...
              if(snapshot.data == null) {
                ...
                return ListTile(
                  ...
                  trailing: IconButton(
                    ...
                    onPressed: () {
                      setState(() {
                        _carLocation = LatLng(snapshot.data.latitude, snapshot.data.longitude);
          ...
          return AlertDialog(
            ...
            actions: <Widget>[
              TextButton(
                ...
                onPressed: () {
                  Navigator.of(context).pushAndRemoveUntil(MaterialPageRoute( builder: (BuildContext context) => OnUseCarPage(id: _id, toDestination: _toDestination, carLocation: _carLocation)), (Route<dynamic> route) => false);
                },
              ),
            ],
          );
