...
class _UpdateProfilePageState extends State<UpdateProfilePage> {
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        Padding(
                            ...
                            child: Image(
                              image: NetworkImage('http://springbootbackendcarsharingapi103-env.eba-2nmwr2r3.us-east-1.elasticbeanstalk.com/api/usuarios/${_id}/image/download'),
                              height: 220,
                            )
                        ),
                        _dividers.defDivider(32.0),
  ...
  Widget _standardImageView() {
    if(imageFile == null){
      return Center(child: Text('Licencia'));
    } else {
